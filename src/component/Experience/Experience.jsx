  ...
  return (
    ...
    >
      ...
      <div className=" h-[80%] w-[90%] flex justify-center items-center gap-6">
        <div className="w-full h-full  rounded-[20px] bg-colorbgvariant flex justify-center flex-col items-center gap-10 hover:bg-colorbg border  border-transparent  hover:border hover:border-gray-600 duration-500">
          <div className="flex justify-around w-full h-[22%]">
            <div className="w-[20%] flex flex-col justify-center items-center">
              <img src="../../../public/Skill/html-5-svgrepo-com.svg" />
              <p className="font-semibold md:text-[18px] text-[14px]">HTML</p>
            </div>
            <div className="w-[20%] flex flex-col justify-center items-center">
              <img src="../../../public/Skill/css-5-svgrepo-com.svg" />
              <p className="font-semibold md:text-[18px] text-[14px]">CSS</p>
            </div>
            <div className="w-[20%] flex flex-col justify-center items-center">
            ...
            {/* <div className="w-[20%] flex flex-col justify-center items-center gap-4">
              ...
              <p className="font-semibold md:text-[18px] text-[14px] mt-[40px]">
                Styled Component
              </p>
            </div> */}
          </div>
          <div className="flex justify-around w-full h-[22%]">
            ...
            <div className="w-[20%] flex flex-col justify-center items-center">
              ...
              <p className="font-semibold md:text-[18px] text-[14px]">React</p>
            </div>
            <div className="w-[20%] flex flex-col justify-center items-center">
              <img src="../../../public/Skill/redux-logo-svgrepo-com.svg" />
              <p className="font-semibold md:text-[18px] text-[14px]">Redux</p>
            </div>
            <div className="w-[20%] flex flex-col justify-center items-center">
            ...
            {/* <div className="w-[20%] flex flex-col justify-center items-center">
              ...
              <p className="font-semibold md:text-[18px] text-[14px]">Git</p>
            </div> */}
          </div>
          <div className="flex justify-around w-full h-[22%]">
            <div className="w-[20%] flex flex-col justify-center items-center">
            ...
            <div className="w-[20%] flex flex-col justify-center items-center">
              <img src="../../../public/Skill/Daco_2749343.png" />
              <p className="font-semibold md:text-[18px] text-[14px]">
                Mongoose
              </p>
            </div>
